namespace CiscoDatabaseProgram.Values
{
    class PublicValues
    {
        // For all the private data, I will enter here a example from the code I used:
        // I used a private class with all my private data
        // The goal of this class is, giving you a example of the code I used

        //    public static string testDatabaseServer = "127.0.0.1";
        //    public static int serverPort = 3306;
        //    public static string serverUsername = "admin";
        //    public static string serverPassword = "admin";
